...
object HtmlToImage {
    ...
    // Simplified JSON parsing for our specific use case
    private fun parseElementsData(jsonString: String): List<Map<String, Any>> {
        ...
        // In a production app, you might want to use a proper JSON library
        ...
        // Split by object boundaries (this is simplified and works for our specific case)

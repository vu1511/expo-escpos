...
public struct CodePageDefinitions {
    public static let definitions: [String: CodePageDefinition] = [
        ...
        "cp857": CodePageDefinition(
            ...
            languages: ["tr"],
            offset: 128,
            chars: "ÇüéâäàåçêëèïîıÄÅÉæÆôöòûùİÖÜø£ØŞşáíóúñÑĞğ¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ºªÊËÈÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµ×ÚÛÙìÿ¯´­±¾¶§÷¸°¨·¹³²■ "
        ),
        ...
        "cp869": CodePageDefinition(
            ...
            languages: ["el"],
            offset: 128,
            chars: "Ά·¬¦''Έ―ΉΊΪΌΎΫ©Ώ²³ά£έήίϊΐόύΑΒΓΔΕΖΗ½ΘΙ«»░▒▓│┤ΚΛΜΝ╣║╗╝ΞΟ┐└┴┬├─┼ΠΡ╚╔╩╦╠═╬ΣΤΥΦΧΨΩαβγ┘┌█▄δε▀ζηθικλμνξοπρσςτ΄­±υφχ§ψ΅°¨ωϋΰώ■ "
        ),
        ...
        "cp936": CodePageDefinition(
            ...
            languages: ["zh"],
            offset: 128,
            chars: "啊阿埃挨哎唉哀皑癌艾爱隘鞍氨安俺按暗岸胺案肮昂盎凹敖熬翱袄傲奥懊澳芭捌扒叭吧笆八疤巴拔跋靶把耙坝霸罢爸白柏百摆佰败拜稗斑班搬扳般颁板版扮拌伴瓣半办绊邦帮梆榜膀绑棒磅蚌镑傍谤苞胞包褒剥"
        ),
        "cp949": CodePageDefinition(
            name: "Korean",
            languages: ["ko"],
            offset: 128,
            chars: "가각간갇갈갉갊감갑값갓갔강갖갗같갚갛개객갠갤갬갭갯갰갱갸갹갼걀걋걍걔걘걜거걱건걷걸걺검겁것겄겅겆겉겊겋게겐겔겜겝겟겠겡겨격겪견겯결겸겹겻겼경곁계곈곌곕곗고곡곤곧골곪곬곯곰곱곳공곶과곽관괄"
        ),
        "cp950": CodePageDefinition(
            name: "Traditional Chinese",
            languages: ["zh"],
            offset: 128,
            chars: "一丁七丈三上不丐且丕世丘丙業叢東絲丞丟並丨丫中丰串臨丸丹主乃久么么之烏乍乎乏樂乒乓喬乖乘乙九乞也習鄉書買亂乳乾了予爭事二于云互五井亞些亟交"
        ),
        "cp1250": CodePageDefinition(
            name: "Central Europe",
            languages: ["hu", "pl", "cz"],
            offset: 128,
            chars: #"€‚ƒ„…†‡ˆ‰Š‹ŚŤŽŹ'""•–—™š›śťžźˇ˘Ł¤¦§¨©«¬®°±²³´µ¶·¸¹»ŒœŸ¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĎĐÑÒÓÔÕÖ×ØÙÚÛÜÝŔŘßàáâãäåæçèéêëìíîïďđñòóôõö÷øùúûüýŕřÿ"#
        ),
        "cp1251": CodePageDefinition(
            name: "Cyrillic",
            languages: ["ru", "bg"],
            offset: 128,
            chars: #"ЂЃ‚ѓ„…†‡€‰Љ‹ЊЌЋЏђ‘'""•–—™љ›њќћџЎўЈ¤Ґ¦§Ё©«¬®Ї°±Ііґµ¶·ё№»јЅѕїАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя"#
        ),
        "cp1252": CodePageDefinition(
            name: "Latin I",
            languages: ["en", "fr", "de"],
            offset: 128,
            chars: #"€‚ƒ„…†‡ˆ‰Š‹ŒŽŸ''""•–—™š›œžŸ¡¢£¤¥¦§¨©ª«¬®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ"#
        ),
        "cp1253": CodePageDefinition(
            name: "Greek",
            languages: ["el"],
            offset: 128,
            chars: #"€‚ƒ„…†‡€‰‹""•–—™›""΅Ά£¤¥¦§¨©«¬®―°±²³΄µ¶·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθικλμνξοπρςστυφχψωϊϋόύώ"#
        ),
        "cp1254": CodePageDefinition(
            name: "Turkish",
            languages: ["tr"],
            offset: 128,
            chars: #"€‚ƒ„…†‡ˆ‰Š‹ŒŽŸ''""•–—™š›œžŸ¡¢£¤¥¦§¨©ª«¬®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ"#
        ),
        "cp1255": CodePageDefinition(
            name: "Hebrew",
            languages: ["he"],
            offset: 128,
            chars: #"€‚ƒ„…†‡ˆ‰‹""•–—™›""¡¢£₪¥¦§¨©×«¬®¯°±²³´µ¶·¸¹÷»¼½¾¿אבגדהוזחטיךכלםמןנסעףפץצקרשתװױײ׳״"#
        ),
        "cp1256": CodePageDefinition(
            name: "Arabic",
            languages: ["ar"],
            offset: 128,
            chars: #"€پ‚ƒ„…†‡ˆ‰ٹ‹Œچژڈگ''""•–—™ڑ›œں،؛ڈ°¢£¤¥¦§¨©ھ«¬®¯°±²³´µ¶·¸¹؛»¼½¾؟ہءآأؤإئابةتثجحخدذرزسشصضطظعغفقكلمنهوىيًٌٍَُِّْ"#
        ),
        "cp1257": CodePageDefinition(
            name: "Baltic",
            languages: ["et", "lt", "lv"],
            offset: 128,
            chars: #"€‚ƒ„…†‡€‰‹""•–—™›""¡¢£¤¥¦§Ø©Ŗ«¬®Æ°±²³"µ¶·ø¹ŗ»¼½¾æĄĮĀĆÄÅÆĒČÉĘĖĢĶĪĻŠŃŅÓŌÕÖ×ŲŁŚŪÜŻŽßąįāćäåæēčéęėģķīļšńņóōõö÷ųłśūüżž˙"#
        ),
    ...
    public static func getCodePagesForLanguage(_ language: String) -> [String] {
        return definitions.filter { $0.value.languages.contains(language) }.map { $0.key }
    }
}
